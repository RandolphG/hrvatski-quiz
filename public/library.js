...
export const possessive_pronominal_adjectives = [
  {
    numb: 1,
    question: "Ovo je _____ knjiga.",
    answer: "moja",
...
export const demonstrative_pronominal_adjectives = [
  {
    numb: 1,
    question:
      "Which word would you use to describe something close to the speaker?",
  ...
  {
    numb: 7,
    question: "Da li si video _____ planinu? (far from speaker and listener)",
    answer: "onaj",
    options: ["onaj", "taj", "ovaj", "njihov", "tvoj"],
  },
  {
  ...
  {
    numb: 10,
    question: "Which demonstrative is used for an object someone is holding?",
    answer: "ovaj",
    options: ["ovaj", "taj", "onaj", "njihov", "vaš"],
  },
  {
  ...
  {
    numb: 20,
    question: "Da li ti se dopada _____ torba pored tebe? (neutral position)",
    answer: "ta",
    options: ["ta", "ova", "ona", "njihova", "naša"],
  },
  {
  ...
  {
    numb: 22,
    question: "_____ film koji sada gledamo je zanimljiv. (close to speaker)",
    answer: "Ovaj",
    options: ["Ovaj", "Taj", "Onaj", "Njegov", "Vaš"],
  },
  {
  ...
  {
    numb: 28,
    question: "_____ stablo ovde je staro preko sto godina. (close to speaker)",
    answer: "Ovo",
    options: ["Ovo", "To", "Ono", "Njihovo", "Moje"],
  },
  {
    numb: 29,
    question: "Da li ti se dopada _____ pesma koju slušamo? (neutral position)",
    answer: "ta",
    options: ["ta", "ova", "ona", "njihova", "naša"],
  },
  {
...
export const word_order = [
  ...
  {
    numb: 15,
    question: "In 'Jeste li student?', what is the grammatical role of 'li'?",
    answer: "question particle",
    options: ["question particle", "verb", "noun", "adjective", "pronoun"],
  },
  {
